    ...
    <>
      ...
      >
        <div className="flex flex-col h-full">
          <div className={`sidebar-brand ${open ? "is-visible" : "is-hidden"}`}>
            ...
            <div className="sidebar-brand__copy">
              <span className="sidebar-brand__title">Project Workspace</span>
              <span className="sidebar-brand__subtitle">Academic management</span>
            </div>
          </div>

          <nav className="sidebar-navigation flex-1 px-4 py-6 space-y-2" aria-label="Primary navigation">
            <p className={`sidebar-navigation__label ${open ? "is-visible" : "is-hidden"}`}>Workspace</p>
            {navigationItems.map((item) => {
              ...
              return (
                <NavLink
                  ...
                  className={({ isActive }) => `
                    sidebar-navigation__link flex items-center px-4 py-3 rounded-lg transition-all duration-200
                    ${isActive
                      ? "sidebar-navigation__link--active bg-blue-50 text-blue-700 border-r-4 border-blue-500"
          ...
          <div className="sidebar-footer p-4 border-t border-slate-200">
            ...
            >
              ...
              <span className="sidebar-footer__version">Version 1.0</span>
            </div>
          </div>
        </div>
      </aside>
      ...
      {open && (
        <div
          className="sidebar-mobile-backdrop fixed inset-0 bg-black bg-opacity-40 z-40 lg:hidden"
      ...
      >
        <div className="flex flex-col h-full pt-16">
          <div className="sidebar-brand sidebar-brand--mobile is-visible">
            <span className="sidebar-brand__mark" aria-hidden="true">
              <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
              </svg>
          ...
          {/* Mobile navigation */}
          <nav className="sidebar-navigation flex-1 px-4 py-6 space-y-2" aria-label="Mobile primary navigation">
            <p className="sidebar-navigation__label is-visible">Workspace</p>
            {navigationItems.map((item) => {
              const isActive = location.pathname === item.path;
              ...
              sidebar-navigation__link flex items-center px-4 py-3 rounded-lg transition-all duration-200
              ${isActive
                      ? "sidebar-navigation__link--active bg-blue-50 text-blue-700"
                      : "text-slate-700 hover:bg-slate-100 hover:text-blue-600"
                    }
            `}
                  onClick={() => setOpen(false)}
