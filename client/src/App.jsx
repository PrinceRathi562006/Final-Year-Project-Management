...
const App = () => {
  ...
  // if user is already login then it will redirect to page based on role, user not have to login again. If token already exist in browser then user will login automatically till he will not logout.
  useEffect(() => {
    dispatch(getUser());
  }, [dispatch]);
